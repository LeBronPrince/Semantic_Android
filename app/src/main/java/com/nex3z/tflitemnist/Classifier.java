...
public class Classifier {
    ...
    private static final String MODEL_NAME = "model_6_14.tflite";

    private static final int BATCH_SIZE = 1;
    public static final int IMG_HEIGHT = 769;
    public static final int IMG_WIDTH = 769;
    ...
    private final int[][] mResult = new int[IMG_HEIGHT][IMG_WIDTH];
...
//                mImageData.putFloat(convertPixel(value));
                mImageData.putFloat((((value >> 16) & 0xFF) - IMAGE_MEAN));
                mImageData.putFloat((((value >> 8) & 0xFF) - IMAGE_MEAN));
                mImageData.putFloat(((value & 0xFF) - IMAGE_MEAN));
